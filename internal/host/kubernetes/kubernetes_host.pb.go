...
// Instantiate a Go-defined module named "kubernetes" that exports host functions.
func Instantiate(ctx context.Context, r wazero.Runtime, hostFunctions Proxy) error {
	envBuilder := r.NewHostModuleBuilder("kubernetes")
	h := _proxy{hostFunctions}
...
func (h _proxy) _Get(ctx context.Context, m api.Module, stack []uint64) {
